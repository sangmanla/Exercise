...
public class CSVReaderNameGenerator {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<randomAddress.length;i++){
			System.out.println(i + ", '" + fNames.get(getRandom(fNames.size())) + "', '" +  lNames.get(getRandom(lNames.size())) + "', " + getRandom(2) + ", (SYSDATE-" + (getRandom(365*40)) + ") " + ", (SYSDATE-" + (getRandom(365*10)) + "), '" + randomAddress[i] + "'");
		}
	}
